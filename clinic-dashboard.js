...
<div class="page">
      ...
      <div style="margin-top:5pt;">
        <div class="allergy-box">
          <div class="row" style="align-items:center;margin-bottom:0;">
            ...
            <div style="flex:1;border-bottom:1px solid #c0392b;min-height:15pt;"></div>
          </div>
        </div>
      </div>
  ...
  <div class="section">
    ...
    <div class="section-body">
      <div class="vitals-grid">
        <div class="vital-box"><label>BP (mmHg)</label><div class="v-line"></div><div class="unit">ความดันโลหิต</div></div>
        <div class="vital-box"><label>PR (bpm)</label><div class="v-line"></div><div class="unit">ชีพจร</div></div>
        <div class="vital-box"><label>RR (/min)</label><div class="v-line"></div><div class="unit">การหายใจ</div></div>
        <div class="vital-box"><label>Temp (°C)</label><div class="v-line"></div><div class="unit">อุณหภูมิ</div></div>
        <div class="vital-box"><label>O₂ Sat (%)</label><div class="v-line"></div><div class="unit">ออกซิเจน</div></div>
        <div class="vital-box"><label>BW / HT</label><div class="v-line"></div><div class="unit">น้ำหนัก / ส่วนสูง (kg/cm)</div></div>
      </div>
    </div>
  </div>
  <div class="section">
    <div class="section-header">อาการสำคัญ — Chief Complaint (CC)</div>
    <div class="section-body"><div class="write-area"></div></div>
  </div>
  <div class="section">
    <div class="section-header">ประวัติการเจ็บป่วยปัจจุบัน — Present Illness (PI)</div>
    <div class="section-body"><div class="write-area-lg"></div></div>
  </div>
  <div class="section">
    <div class="section-header">การตรวจร่างกาย — Physical Examination (PE)</div>
    <div class="section-body"><div class="write-area-xl"></div></div>
  </div>
  <div class="section">
  ...
  <div class="section">
    ...
    <div class="section-body" style="padding-bottom:4pt;">
      <table class="drugs-table">
        <thead><tr><th style="width:5%;">ลำดับ</th><th style="width:32%;">ชื่อยา (Drug Name)</th><th style="width:15%;">ปริมาณ / ขนาด (Dose)</th><th style="width:18%;">วิธีใช้ (Sig)</th><th style="width:10%;">จำนวน (Qty)</th><th style="width:10%;">หน่วย (Unit)</th><th style="width:10%;">ราคา (Price)</th></tr></thead>
        <tbody>${Array.from({length:8},(_,i)=>`<tr><td style="text-align:center;">${i+1}</td><td></td><td></td><td></td><td></td><td></td><td></td></tr>`).join('')}</tbody>
      </table>
    </div>
  </div>
  <div class="section">
    ...
    <div class="section-body" style="padding-bottom:4pt;border-color:#1e8449;">
      <table class="services-table">
        <thead><tr><th style="width:5%;">ลำดับ</th><th style="width:45%;">รายการ (Service / Procedure)</th><th style="width:15%;">ประเภท (Category)</th><th style="width:10%;">จำนวน (Qty)</th><th style="width:10%;">หน่วย (Unit)</th><th style="width:15%;">ราคา (Price)</th></tr></thead>
        <tbody>${Array.from({length:5},(_,i)=>`<tr><td style="text-align:center;">${i+1}</td><td></td><td></td><td></td><td></td><td></td></tr>`).join('')}</tbody>
      </table>
    </div>
  </div>
  <div class="sig-row">
  ...
  <div class="notice">⚠️ แบบฟอร์มนี้ใช้สำหรับกรณีระบบคอมพิวเตอร์ไม่พร้อมใช้งานเท่านั้น • กรุณากรอกข้อมูลครบถ้วนและนำส่งเจ้าหน้าที่เพื่อบันทึกเข้าระบบเมื่อระบบกลับมาใช้งานได้ • ข้อมูลผู้ป่วยเป็นความลับ</div>
  <div style="font-size:8pt;color:#aaa;text-align:right;margin-top:4pt;">พิมพ์เมื่อ: ${new Date().toLocaleString('th-TH')}</div>
</div>
<div style="text-align:center;margin:18px 0 0;font-family:'Sarabun',sans-serif;" class="no-print">
